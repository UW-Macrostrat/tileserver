"""
This implementation of repeat_every is a copy of the one from fastapi_utils.tasks.py.
It is copied here to avoid a dependency on fastapi_utils, which is not kept up to date
with the latest versions of SQLAlchemy and other dependencies.
"""
